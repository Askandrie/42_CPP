...
/*   Updated: 2025/03/03 19:06:01 by aska             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Dog::Dog()
{
	...
	std::cout << HBLU << this->type << RESET << "\tdefault constructor called"
	          << std::endl;
}
...
Dog::Dog(const Dog &src) : Animal()
{
	...
	std::cout << HBLU << this->type << RESET << "\tcopy constructor called"
	          << std::endl;
}
...
Dog &Dog::operator=(const Dog &ori)
{
	...
	std::cout << HBLU << this->type << RESET << "\tassignment operator called"
	          << std::endl;
	return *this;
}
...
{
	delete this->brain;
	std::cout << RED << this->type << "\tdestructor called" << RESET
	          << std::endl;
}
