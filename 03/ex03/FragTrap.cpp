...
FragTrap::FragTrap() : ClapTrap()
{
	...
	std::cout << "FragTrap\t" << HMAG << name << RESET << "\tconstructed"
	          << std::endl;
}
...
FragTrap::FragTrap(std::string name) : ClapTrap(name)
{
	...
	this->energyPoints = DEFAULT_FRAGTRAP_ENERGY_POINTS;
	this->attackDamage = DEFAULT_FRAGTRAP_ATTACK_DAMAGE;
	std::cout << "FragTrap\t" << HMAG << this->name << RESET
...
{
	*this = origin;
	std::cout << "FragTrap\t" << HMAG << name << RESET << "\tcopied"
	          << std::endl;
}

FragTrap::~FragTrap()
{
	std::cout << "FragTrap\t" << HMAG << name << RESET << "\tdestroyed"
	          << std::endl;
}
