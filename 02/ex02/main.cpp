...
int main(void)
{
	...
	std::cout << HYEL "b " RESET
	                  "is created with param( Fixed( 5.05f ) * Fixed( 2 ) )"
	          << std::endl;
	...
	std::cout << HBLU "Max between a and b = " RESET << Fixed::max(a, b)
	          << std::endl;
	std::cout << HBLU "Min between a and b = " RESET << Fixed::min(a, b)
	          << std::endl;
	std::cout << std::endl;
