...
int main(void)
{
	...
	std::cout << HYEL "a" RESET " is " << a.toInt() << " as integer"
	          << std::endl;
	std::cout << HYEL "b" RESET " is " << b.toInt() << " as integer"
	          << std::endl;
	std::cout << HYEL "c" RESET " is " << c.toInt() << " as integer"
	          << std::endl;
	std::cout << HYEL "d" RESET " is " << d.toInt() << " as integer"
	          << std::endl;
	return 0;
}